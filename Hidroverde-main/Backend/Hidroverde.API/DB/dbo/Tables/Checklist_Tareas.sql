CREATE TABLE [dbo].[Checklist_Tareas] (
    ...
    [tipo_cultivo_id]   INT            NULL,                   -- Opcional: si la tarea es específica para un tipo de cultivo
    [orden]             INT            NOT NULL,               -- Número de paso / orden
    [descripcion]       NVARCHAR (500) NOT NULL,
    [responsable_rol]   NVARCHAR (50)  NULL,                   -- Ej: 'Operario', 'Supervisor'
